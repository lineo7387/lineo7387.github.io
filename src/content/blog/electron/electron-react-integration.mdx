---
title: React / Vue 与 Electron 集成
description: 使用 electron-vite 工具链整合 Vite + React/Vue + Electron，配置路由（React Router / Vue Router），实现主进程与渲染进程状态共享（Zustand IPC 桥接）
pubDate: 2026-04-12
category: electron
tags: [electron, react, vue, vite, electron-vite, zustand]
featured: false
draft: false
author: AI-Writer
readingTime: 13
planId: electron-react-integration
---
