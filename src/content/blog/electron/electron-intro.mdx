---
title: Electron 入门与核心架构
description: 了解 Electron 的双引擎架构（Chromium + Node.js）、主进程与渲染进程的职责分工，快速搭建第一个 Hello World 应用，掌握 BrowserWindow 基本配置
pubDate: 2026-04-12
category: electron
tags: [electron, 入门, 架构, 进程]
featured: false
draft: false
author: AI-Writer
readingTime: 8
planId: electron-intro
---
