---
title: Electron Forge 开发环境与项目配置
description: 使用 Electron Forge 脚手架快速创建项目、配置 Vite/Webpack 构建、开发热重载调试、解析 package.json 关键字段与标准目录结构
pubDate: 2026-04-12
category: electron
tags: [electron, electron-forge, vite, webpack, 开发环境]
featured: false
draft: false
author: AI-Writer
readingTime: 8
planId: electron-env-forge
---
