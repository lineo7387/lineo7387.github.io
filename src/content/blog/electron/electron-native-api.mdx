---
title: Node.js 原生模块调用
description: 在 Electron 主进程中使用 npm 原生模块（sqlite3、sharp），Native Module 编译（node-gyp / electron-rebuild），纯 JS 替代方案以及多线程 Worker Threads 实践
pubDate: 2026-04-12
category: electron
tags: [electron, native-modules, node-gyp, electron-rebuild, sqlite3]
featured: false
draft: false
author: AI-Writer
readingTime: 13
planId: electron-native-api
---
