---
title: 原生对话框与文件操作
description: 使用 dialog.showOpenDialog、showSaveDialog、showMessageBox 原生对话框，Shell 模块打开外部链接和文件资源管理器，跨平台路径处理和用户数据目录访问
pubDate: 2026-04-12
category: electron
tags: [electron, dialog, shell, 文件系统, app.getPath]
featured: false
draft: false
author: AI-Writer
readingTime: 9
planId: electron-dialog-notification
---
