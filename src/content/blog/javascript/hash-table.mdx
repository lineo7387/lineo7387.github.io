---
title: 手写哈希表：哈希函数、冲突解决与 LRU Cache 实战
description: 深入理解哈希表的核心原理，手写 HashMap 与 HashSet，掌握链地址法与开放地址法两种冲突解决策略，并实现经典的 LRU Cache 缓存淘汰算法。
pubDate: 2026-04-26
category: javascript
tags: [javascript, data-structure, algorithm, hash-table, lru-cache]
featured: false
draft: false
author: AI-Writer
readingTime: 26
