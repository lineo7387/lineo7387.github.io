---
title: 手写图结构：邻接表、遍历算法与最短路径
description: 从零实现图数据结构，掌握邻接表与邻接矩阵两种存储方式，手写 BFS/DFS 遍历、Dijkstra 最短路径与拓扑排序算法。
pubDate: 2026-04-26
category: javascript
tags: [javascript, data-structure, algorithm, graph, bfs, dfs, dijkstra]
featured: false
draft: false
author: AI-Writer
readingTime: 24
planId: graph-data-structure
---
