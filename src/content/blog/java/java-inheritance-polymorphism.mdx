---
title: 继承、多态与接口
description: 深入讲解 Java 的继承机制（extends）、方法重写（@Override）、多态表现、接口定义（interface）与抽象类（abstract class）
pubDate: 2026-04-10
category: java
tags: [java, 继承, 多态, 接口, 抽象类, Override]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: java-inheritance-polymorphism
---
