---
title: 数据访问：JPA 与 MyBatis
description: Spring Data JPA 实体映射与 Repository 接口、MyBatis-Plus 增强用法、JdbcTemplate 原始查询、事务管理（@Transactional 传播行为与隔离级别）完整指南
pubDate: 2026-04-11
category: springboot
tags: [springboot, jpa, mybatis, spring-data-jpa, jdbc, transaction]
featured: false
draft: false
author: AI-Writer
readingTime: 15
planId: springboot3-data-access
---
