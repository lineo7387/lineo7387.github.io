---
title: Spring Security 安全认证
description: Spring Security 6.x 核心架构、认证与授权概念、基于 JWT 的无状态登录实现、OAuth 2.0 资源服务器入门、@PreAuthorize 方法级安全注解
pubDate: 2026-04-11
category: springboot
tags: [springboot, spring-security, jwt, oauth2, authentication]
featured: false
draft: false
author: AI-Writer
readingTime: 15
planId: springboot3-security
---
