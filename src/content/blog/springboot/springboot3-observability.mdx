---
title: Spring Boot 3 监控、可观测性与性能调优
description: Spring Boot Actuator 端点、Micrometer + Prometheus + Grafana 可观测性栈集成、自定义指标、JVM 参数调优与 HikariCP 连接池优化
pubDate: 2026-04-11
category: springboot
tags: [springboot, actuator, micrometer, prometheus, grafana, observability, jvm, performance]
featured: false
draft: false
author: AI-Writer
readingTime: 15
planId: springboot3-observability
---
