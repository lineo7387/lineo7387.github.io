...
description: 深入理解 @SpringBootApplication 注解组合、自动配置生效机制（spring.factories 与 AutoConfiguration.imports）、自定义 Starter 的编写方法
pubDate: 2026-04-11
category: springboot
tags: [springboot, java, auto-configuration, starter]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: springboot3-auto-config
---
