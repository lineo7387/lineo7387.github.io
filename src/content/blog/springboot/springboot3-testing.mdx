---
title: 单元测试与集成测试
description: "@SpringBootTest 集成测试、@MockBean 模拟依赖、@WebMvcTest 切片测试 REST 接口、AssertJ 断言库、测试数据库配置与 Spring Boot Test 新特性"
pubDate: 2026-04-11
category: springboot
tags: [springboot, testing, junit, mockito, spring-boot-test]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: springboot3-testing
---
