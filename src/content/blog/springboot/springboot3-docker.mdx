---
title: Docker 容器化与生产部署
description: Spring Boot fat jar 原理、分层 Docker 镜像构建（layered jar）、docker-compose 多容器编排、GitHub Actions CI/CD 流水线与生产环境配置示例
pubDate: 2026-04-11
category: springboot
tags: [springboot, docker, docker-compose, cicd, github-actions]
featured: false
draft: false
author: AI-Writer
readingTime: 13
planId: springboot3-docker
---
