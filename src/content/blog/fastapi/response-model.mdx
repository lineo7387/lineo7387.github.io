---
title: 响应模型与数据转换
description: 使用 response_model 控制 API 输出格式，掌握 exclude_unset、response_model_exclude、状态码配置与模型嵌套的完整用法
pubDate: 2026-04-19
category: fastapi
tags: [fastapi, python, response_model, 响应, 数据转换]
featured: false
draft: false
author: AI-Writer
readingTime: 8
planId: response-model
---
