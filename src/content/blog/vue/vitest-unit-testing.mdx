---
title: Vitest 单元测试
description: 使用 Vitest 和 Vue Test Utils 进行 Vue 3 组件单元测试，包括测试配置、组件测试、Composables 测试以及模拟异步数据等实战技巧
pubDate: 2026-04-11
category: vue
tags: [vue, vue3, vitest, testing, 单元测试]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: vitest-unit-testing
---
