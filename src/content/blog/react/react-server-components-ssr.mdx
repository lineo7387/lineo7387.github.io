---
title: React Server Components 与 SSR
description: 深入理解 RSC 原理、服务端与客户端组件边界、流式渲染、Next.js App Router，掌握 React 服务端渲染新范式
pubDate: 2026-04-11
category: react
tags: [react, rsc, ssr, nextjs, 服务端渲染]
featured: false
draft: false
author: AI-Writer
readingTime: 14
planId: react-server-components-ssr
---
