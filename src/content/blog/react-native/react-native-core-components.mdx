---
title: 核心组件一览
description: 掌握 React Native 中最常用的基础组件：View、Text、Image、TextInput、ScrollView、FlatList 的用法与注意事项
pubDate: 2026-04-11
category: react-native
tags: [react-native, 组件, UI, 入门]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: react-native-core-components
---
