---
title: Props 与 State 基础
description: 理解 React Native 中组件间数据传递的核心机制：Props 的只读性与传递方式、State 的声明式更新，以及组件生命周期的基本概念
pubDate: 2026-04-11
category: react-native
tags: [react-native, props, state, 入门]
featured: false
draft: false
author: AI-Writer
readingTime: 8
planId: react-native-props-state
---
