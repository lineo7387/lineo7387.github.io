---
title: TypeScript 基础类型与类型推断
description: 深入讲解 TypeScript 的原始类型、数组、元组、unknown、never 等基础类型，以及类型推断机制与类型注解的使用方法
pubDate: 2026-04-13
category: typescript
tags: [typescript, types, type-inference]
featured: false
draft: false
author: AI-Writer
readingTime: 10
planId: typescript-basics
---
