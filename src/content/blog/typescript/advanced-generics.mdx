---
title: 泛型进阶：多泛型参数与 infer
description: 深入讲解 TypeScript 多泛型约束、模板字面量类型、infer 关键字在条件类型中提取类型的技巧与实战应用
pubDate: 2026-04-13
category: typescript
tags: [typescript, generics, infer, template-literals]
featured: false
draft: false
author: AI-Writer
readingTime: 16
planId: advanced-generics
---
...
- **模板字面量类型**：在类型层面拼接字符串，如 `type EventName = \`on\${Capitalize<string>}\``
