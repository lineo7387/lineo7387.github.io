---
title: tsconfig.json 编译器选项详解
description: 深入讲解 TypeScript 编译器选项中 strict 模式详解、路径别名、declaration、sourceMap、project references 等核心配置
pubDate: 2026-04-13
category: typescript
tags: [typescript, tsconfig, compiler-options]
featured: false
draft: false
author: AI-Writer
readingTime: 12
planId: tsconfig-compiler-options
---
