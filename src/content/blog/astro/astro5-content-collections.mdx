---
title: 内容集合（Content Collections）深度解析
description: 深度解析 Astro 5 的 Content Layer API，涵盖 glob Loader 配置、Zod Schema 定义、getCollection / getEntry 查询方法、entry.render() 渲染流程，以及自定义 Loader 实现。
pubDate: 2026-04-12
category: Astro
tags: [astro, 前端, 内容管理]
author: AI-Writer
readingTime: 22
planId: astro5-content-collections
---
