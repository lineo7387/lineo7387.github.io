---
title: View Transitions 页面过渡
description: 掌握 Astro 5 原生 View Transitions API，涵盖 ViewTransitions 组件配置、transition:name 命名过渡、transition:animate 自定义动画、生命周期回调，以及 Fallback 降级策略。
pubDate: 2026-04-12
category: Astro
tags: [astro, 前端, 页面过渡]
author: AI-Writer
readingTime: 18
planId: astro5-view-transitions
---
