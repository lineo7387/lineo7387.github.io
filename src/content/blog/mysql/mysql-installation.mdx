---
title: MySQL 安装与配置
description: 在 macOS、Linux、Windows 上安装 MySQL 8.x、启动服务、配置连接，并介绍常用客户端工具 MySQL Workbench、DBeaver 与命令行 CLI 的使用方法
pubDate: 2026-04-20
category: mysql
tags: [mysql, 数据库, 安装, 入门]
featured: false
draft: false
author: AI-Writer
readingTime: 5
planId: mysql-installation-setup
---
