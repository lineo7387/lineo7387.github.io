---
title: 自定义扩展开发
description: 深入掌握 htmx.defineExtension API，学习创建自定义行为扩展，理解扩展的生命周期钩子与钩子函数
pubDate: 2026-04-25
category: htmx
tags: [htmx, extensions, advanced, api]
featured: false
draft: false
author: AI-Writer
readingTime: 8
planId: custom-extensions
---
...
> **注意**：`onEvent` 对所有 htmx 事件都会被调用，包括 `htmx:load`、`htmx:configRequest`、`htmx:afterSwap` 等。通过事件名过滤来处理你关心的事件。
