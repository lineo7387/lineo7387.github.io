---
title: hx-get 与 hx-post 基础请求
description: 深入掌握 htmx 的基本 HTTP 请求属性，学习如何通过声明式 hx-get、hx-post 发起异步请求，以及请求指示器和错误处理机制
pubDate: 2026-04-25
category: htmx
tags: [htmx, ajax, hx-get, hx-post, http]
featured: false
draft: false
author: AI-Writer
readingTime: 5
planId: hx-get-post-basics
---
